...
/**
 * Form component for experiment data.
 */
@Component({
  selector: 'bch-experimental-data-form',
  templateUrl: './experimental-data-form.component.html',
  styleUrls: ['./experimental-data-form.component.scss']
})
export class ExperimentalDataFormComponent implements OnInit, AfterViewInit, OnDestroy {
   ...
   */
  ngOnInit(): void {
    this.form = this.experimentFormService.getExperimentFormSubGroup('experimentalData');
  }
