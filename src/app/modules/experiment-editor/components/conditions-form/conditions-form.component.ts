...
export class ConditionsFormComponent implements OnInit, AfterViewInit, OnDestroy {
   ...
   */
  ngOnInit(): void {
    this.form = this.experimentFormService.getExperimentFormSubGroup('conditions');
  }
